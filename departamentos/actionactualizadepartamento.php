<?php
    ...
    $consu="update departamento set Nombre_departamento='$nombre',descripcion='$descripcion',usuario_actualiza='$usuarioactualiza',fecha_actualiza='$fechaa' where id_departamento='$id';";
       ...
       <?php include_once "../componentes/asidemenu.php"; ?>
        <section class="principal">
            ...
            <div class="targetaform">
                ...
                ?>
                <div class="center">
                    <a  class="regresar" href="../departamentos/verdepartamentos.php">Volver</a>
                </div>
