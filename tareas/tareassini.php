<?php
 ...
 INNER JOIN usuarios as u on u.id_usuario = t.id_usuario where t.estado='No iniciada'order by t.id_tarea ASC";
...
<head>
    ...
    <title>Tareas no iniciadas</title>
    ...
    <section class="contenedor">
       <?php include_once "../componentes/asidemenu.php"; ?>
        <section class="principal">
            ...
            <div class="contprin">
            <div class="targeta">
            <h1 class="titular">Tareas no iniciadas</h1>
