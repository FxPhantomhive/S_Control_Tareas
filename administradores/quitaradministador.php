<?php
    ...
    $consu="update usuarios set tipo_usuario='normal',fecha_actualiza='$fechaa' where id_usuario='$id';";
            ...
            <div class="targetaform">
                ...
                <?php
                    if(mysqli_connect_errno()){
                        ...
                        echo "<h1 class='mensajesconfirmacion'>El usuario ya no cuenta con derechos de administrador</h1>";
                    }
