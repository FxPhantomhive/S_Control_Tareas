    ...
    <section class="contenedor">
       <?php include_once "../componentes/asidemenu.php"; ?>
        <section class="principal">
            ...
            <h1 class="titular">Modificar Cargo</h1>
                <?php
                $id = $_GET['id'];
                ...
                ?>
               <form action="actionactualizarcargo.php" method="post" ENCTYPE="multipart/form-data">                
               <table>
               <input type="hidden" name="id" value="<?php echo $row['id_cargo']; ?>">               
               <input type="hidden" name="uactualiza" value="<?php echo $_SESSION['sesion']; ?>">
                    <tr>
                        <td><label>Nombre Cargo:</label></td>
                        <td><input type="text" name="nombre" id="nombre" size="35" value="<?php echo $row['Nombre_cargo']; ?>" required></td>
                    </tr>
                    <tr>
