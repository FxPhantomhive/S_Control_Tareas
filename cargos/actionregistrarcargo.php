       ...
       <?php include_once "../componentes/asidemenu.php"; ?>
        <section class="principal">
            ...
            <div class="targetaform">
                <h1 class="titular">Registrar Cargo</h1>
                <?php
                ...
                ?>
                <div class="center">
                    <a  class="regresar" href="../cargos/vercargos.php">Regresar al menu</a>
                </div>
