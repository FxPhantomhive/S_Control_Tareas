<?php
    ...
    $consu="update cargo set Nombre_cargo='$nombre',descripcion='$descripcion',usuario_actualiza='$usuarioactualiza',fecha_actualiza='$fechaa' where id_cargo='$id';";
       ...
       <?php include_once "../componentes/asidemenu.php"; ?>
        <section class="principal">
            ...
            <div class="targetaform">
                ...
                ?>
                <div class="center">
                    <a  class="regresar" href="../cargos/vercargos.php">Volver</a>
                </div>
